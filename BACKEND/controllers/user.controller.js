...
export const register=async (req, res) => {
    ...
    await newUser.save();
    return res.status(201).json({message:"User registered successfully ${fullname}",
    success: true, 
        ...
        console.error(error);
        res.status(500).json({message:"Something went wrong in registering",
    success: false, 
}); 
    }
};
...
return res.status(200).json({
    ...
    success: true,  
        ...
        console.error(error);
        res.status(500).json({message:"Something went wrong in update profile",
        success: false,
    });
    }
};